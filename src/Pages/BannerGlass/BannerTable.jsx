...
import { phoneGlassCategoryId } from '../../shared/_helper/category-id';
...
const BannerTable = () => {
  ...
  useEffect(() => {
    dispatch(getBanner(formVar.limit, formVar.offset, formVar.status, formVar.keyword, phoneGlassCategoryId))
  }, []);
