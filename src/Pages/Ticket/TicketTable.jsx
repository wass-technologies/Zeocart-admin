...
const TicketTable = () => {
  const storeVar = useSelector(state => state.ticket)
  ...
  return (
    <Fragment>
      <Col sm='12'>
        <Card>
          ...
          <div className='table-responsive'>
            <Table hover={true} className='table-border-horizontal table-light'>
              ...
              <tbody>
                {storeVar.ticketData?.map((item, index) => (
                  <tr key={item.id}>
        ...
        {
          storeVar.ticketData.length>0 &&
        <Pagination currentPage={formVar.currentPage} totalItem={storeVar.totalTicket}
